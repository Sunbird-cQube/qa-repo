...
Feature: Test Spec Transformer API 
@setup=project
@ignore
Scenario:
    * def actual_request = read('classpath:src/test/java/cqube/SpecAPI/spec_validator/transformer_validator.json')

Scenario Outline: ${__row.scenario}

    Given url "https://cqube-qa.tibilprojects.com/"
    Given path '/spec/transformer'
    * def api_url = "https://cqube-qa.tibilprojects.com/spec/transformer"
