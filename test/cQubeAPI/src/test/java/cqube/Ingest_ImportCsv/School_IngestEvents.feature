...
Feature: Ingestion of School Statistics Event Data Files
...
Scenario Outline: upload image
    ...
    * if (responseStatus == 200 )  karate.call('School_IngestEvents.feature@valid')
    * if (responseStatus == 400) karate.call('School_IngestEvents.feature@invalid')
    * if (responseStatus == 500 || responseStatus == 501 || responseStatus == 502 || responseStatus == 503 || responseStatus == 504 ) karate.fail('Server error')
        ...
        |event_school_statistics_teachers.csv|
